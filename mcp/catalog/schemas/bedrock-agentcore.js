...
export const zodSchema = z
  .object({
    ...
    browser_session_io_wait_percent: z.number().min(0).max(100).default(0).describe("Browser Tools — I/O wait percent. Shares the \"I/O Wait Time (%) Enter %\""),
    ...
    code_interpreter_io_wait_percent: z.number().min(0).max(100).default(0).describe("Code Interpreter — I/O wait percent. Shares the \"I/O Wait Time (%) Enter %\""),
